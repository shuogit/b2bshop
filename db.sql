...
#插入一条记录作为管理员
insert into ci_admin(admin_name,password,email) values('admin','21232f297a57a5a743894a0e4a801fc3','admin@itcast.cn');
insert into ci_admin(admin_name,password,email) values('admin','admin','admin@itcast.cn');



#类别部分，先插入部分数据，做测试
insert into ci_category(cat_name,parent_id) values('手机类型',0);
insert into ci_category(cat_name,parent_id) values('充值卡',0);
insert into ci_category(cat_name,parent_id) values('手机配件',0);
insert into ci_category(cat_name,parent_id) values('CDMA手机',1);
insert into ci_category(cat_name,parent_id) values('3G手机',1);
insert into ci_category(cat_name,parent_id) values('iphone 4s',5);
insert into ci_category(cat_name,parent_id) values('联通手机充值卡',2);
insert into ci_category(cat_name,parent_id) values('移动手机充值卡',2);
insert into ci_category(cat_name,parent_id) values('耳机',3);
insert into ci_category(cat_name,parent_id) values('电池',3);
